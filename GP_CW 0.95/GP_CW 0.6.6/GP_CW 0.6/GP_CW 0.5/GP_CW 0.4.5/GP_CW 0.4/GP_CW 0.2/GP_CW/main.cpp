...
D3DXVECTOR3 balloonTrans = D3DXVECTOR2 (300,300);
D3DXVECTOR3 playerTrans = D3DXVECTOR2  (300,300);
...
char* balloonTxtres[] = {"Images\\zombie.jpg","Images\\zombie2.jpeg", "Images\\zombie3.png", "Images\\zombie4.jpg","Images\\Survivor.png" };
...
bool initWindow( HINSTANCE hInstance )
{
	...
	wndHandle = CreateWindow("Balloons",			// the window class to use
							 "Zombieworld",			// the title bar text
...
/* The following code was used to change the game state but was unsuccessful
...
if(timeElapsed > fpsRate)
			{
				...
				aSurface = d3dMgr->getD3DSurfaceFromFile("Images\\Intro.jpg");
				d3dMgr->beginRender();
				theBackbuffer = d3dMgr->getTheBackBuffer();
				d3dMgr->updateTheSurface(aSurface, theBackbuffer);
				d3dMgr->releaseTheBackbuffer(theBackbuffer);
